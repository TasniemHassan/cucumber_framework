...
public class HeroAppSteps {
    ...
    public void userShouldSeeHeading(String headingText) {
        switch (headingText) {
            ...
            break;
            case "Context Menu":
                Assert.assertTrue(heroAppPage.contextMenuH3.isDisplayed());
                Assert.assertEquals(headingText, heroAppPage.contextMenuH3.getText());
                break;
            default:
                throw new NotFoundException("The heading is not displayed properly in the feature file");
        }
    }
    ...
    public void userShouldSeeText(String paragraphText) {
        switch (paragraphText) {
            ...
            case "Right-click in the box below to see one called 'the-internet'. When you click it, it will trigger a JavaScript alert.":
                ...
                break;
            default:
                throw new NotFoundException("The paragraph is not displayed properly in the feature file");
        }
    }
    ...
    public void userShouldSeeAMessageStartsWith(String errorMessage) {
        Assert.assertTrue(heroAppPage.loginErrorMessage.isDisplayed());
