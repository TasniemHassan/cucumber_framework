...
public class GoogleSteps {
    ...
    public void userShouldSeeResultsAreMoreThan(long result) {
       String results = googleSearchPage.resultBar.getText();
       // Assert.assertTrue( Long.parseLong(results.substring(results.indexOf(" ") + 1, results.indexOf("results")-1).replaceAll(",", "")) > result);
